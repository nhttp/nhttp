...
<p align="center">
   ...
   <a href="https://deno.land/x/nhttp"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fdeno-visualizer.danopia.net%2Fshields%2Flatest-version%2Fx%2Fnhttp@1.1.17%2Fmod.ts" alt="denoland" /></a>
   <a href="https://deno.land/x/nhttp"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fdeno-visualizer.danopia.net%2Fshields%2Fdep-count%2Fhttps%2Fdeno.land%2Fx%2Fnhttp@1.1.17%2Fmod.ts" alt="deps" /></a>
   <a href="https://deno.land/x/nhttp"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fdeno-visualizer.danopia.net%2Fshields%2Fcache-size%2Fhttps%2Fdeno.land%2Fx%2Fnhttp@1.1.17%2Fmod.ts" alt="size" /></a>
...
```ts
import { nhttp } from "https://deno.land/x/nhttp@1.1.17/mod.ts";
```

### deno-npm

```ts
import { nhttp } from "npm:nhttp-land@1.1.17";
```

### nest.land

```ts
import { nhttp } from "https://x.nest.land/nhttp@1.1.17/mod.ts";
```
