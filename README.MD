...
> Note: maybe not relevan if compare with std/http or other Deno framework using std/http. nhttp use native deno http. 
...
body and file is available where use jsonBody, urlencodedBody or multipartBody.
```ts
