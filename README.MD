...
`app[METHOD](path: string | RegExp, ...handlers);`
...
```ts
const app = new NHttp({ flash: true });
```
...
NHttp auto parse the body. Support json, urlencoded, multipart, raw.
