...
type HxSwap = "innerHTML" | "outerHTML" | "beforebegin" | "afterbegin" | "beforeend" | "afterend" | "delete" | "none" | "morph" | "morphdom";
type HxTarget = "this" | "closest " | "find " | "next " | "previous ";
type HxSync = ":drop" | ":abort" | ":replace" | ":queue" | ":queue first" | ":queue last" | ":queue all";
type HxTriggerModifier = " once" | " changed" | " delay:" | " throttle:" | " from:" | " target:" | " consume" | " queue:first" | " queue:last" | " queue:all" | " queue:none";
